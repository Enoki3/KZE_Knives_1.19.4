...
import kzeknife.item.renderer.RawfishItemRenderer;
...
public class RawfishItem extends HoeItem implements GeoItem {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new RawfishItemRenderer();
