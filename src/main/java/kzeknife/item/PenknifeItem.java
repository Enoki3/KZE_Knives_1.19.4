...
import kzeknife.item.renderer.PenknifeItemRenderer;
...
public class PenknifeItem extends HoeItem implements GeoItem {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new PenknifeItemRenderer();
