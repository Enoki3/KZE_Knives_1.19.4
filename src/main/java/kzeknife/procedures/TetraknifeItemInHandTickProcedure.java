...
public class TetraknifeItemInHandTickProcedure {
	public static void execute(Entity entity, ItemStack itemstack) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.DIAMOND_HOE
				...
				&& (entity.getCapability(KzeKnifeModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new KzeKnifeModVariables.PlayerVariables())).Tetra_knife_switch == false) {
			{
				...
				entity.getCapability(KzeKnifeModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
					capability.Tetra_knife_number = _setval;
			...
			if ((entity.getCapability(KzeKnifeModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new KzeKnifeModVariables.PlayerVariables())).Tetra_knife_number > 1) {
				if ((entity.getCapability(KzeKnifeModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new KzeKnifeModVariables.PlayerVariables())).Tetra_knife_pick1 == false) {
						...
						itemstack.getOrCreateTag().putString("geckoAnim", "pick1");
					{
						...
						entity.getCapability(KzeKnifeModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
							capability.Tetra_knife_pick1 = _setval;
							capability.syncPlayerVariables(entity);
						});
					}
					{
						...
						entity.getCapability(KzeKnifeModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
							capability.Tetra_knife_pick2 = _setval;
							capability.syncPlayerVariables(entity);
						});
					}
				} else {
